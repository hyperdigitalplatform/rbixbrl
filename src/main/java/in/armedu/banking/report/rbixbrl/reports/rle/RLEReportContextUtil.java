...
public class RLEReportContextUtil {
    ...
    public static Context createFromToContextWithMembers(String bankCode, String startDate, String endDate, String countryCode,String branchCode,String nameOfBorrower, Map<String, String> emMap ){
        ObjectFactory xbrlObjectFactory = new ObjectFactory();
        String contextRefFromToForBorrowerString = ContextUtil.getIdForFromTo("fromto", startDate, endDate, emMap.values()  ,countryCode  ,branchCode  ,nameOfBorrower  );
        ...
        List<TypedMember> typeMembers = createTypedMembers( countryCode, branchCode, nameOfBorrower); 
    ...
    public static Context createAsOfContextWithMembers(String bankCode, String reportDate,  String countryCode, String branchCode, String nameOfBorrower, Map<String, String> emMap ){
        ObjectFactory xbrlObjectFactory = new ObjectFactory();
        String contextRefAsOfFundTypeString = ContextUtil.getIdForAsOf("asof", reportDate, emMap.values() ,countryCode,branchCode,nameOfBorrower);
