...
public class XBRLApplication {
    public static void main(String[] args) throws Exception {
        ...
        partA3.setTotalDividendsPaid("0");
        ...
        partA4.setTotalDividendsPaid("0");
        ...
        partA5.setNonPerformingInvestments("0");
        ...
        partA5.setProvisionsHeldAgainstNonPerformingInvestments("0");
        partA5.setProvisionsHeldAgainstNonPerformingLoans("6962330000");
        partA5.setProvisionsRequiredAgainstNonPerformingInvestments("0");
        ...
        partA5.setTotalDividendsPaid("0");
